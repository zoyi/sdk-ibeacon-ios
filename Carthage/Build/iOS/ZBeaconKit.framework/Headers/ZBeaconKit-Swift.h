...
- (nonnull instancetype)initWithEmail:(NSString * _Nonnull)email authToken:(NSString * _Nonnull)token brandId:(NSInteger)brandId target:(enum Target)target OBJC_DESIGNATED_INITIALIZER;
- (void)start;
- (void)stop;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
